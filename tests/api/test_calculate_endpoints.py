...
def test_calculate_rating():
    influencers = [
        {
            "id": str(uuid.uuid4()),
            "name": "Will Beech",
            "img": "https://media.licdn.com/dms/image/v2/D4E03AQGW8UQAVwjY4A/profile-displayphoto-shrink_400_400/B4EZY4gnRDHUAk-/0/1744704796236?e=1758758400&v=beta&t=suVk8qCFgySgDn_upnXSjUhxYHv5TX_vIwB1NSJ2A_s",
            "audience": {
                "size": 797,
                "executive": 20,
                "professionals": 767,
    ...
    response = client.post("/calculate/", json=influencers)
    assert response.status_code == 200
    assert response.json()["message"] == "Rating calculated successfully!"